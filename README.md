...
app/                    --> all of the source files for the application
  ...
  view1/                --> the view1 view template and logic
    ...
    certificationIssuance.js              --> the controller logic
    certificationIssuance_test.js         --> tests of the controller
  view2/                --> the view2 view template and logic
    view2.html            --> the partial template
    findPostcode.js              --> the controller logic
    findPostcode_test.js         --> tests of the controller
